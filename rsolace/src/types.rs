...
pub enum SolClientSubCodeOrU32 {
...
pub struct ErrorInfo {
    pub sub_code: SolClientSubCodeOrU32,
            ...
            unsafe {
                ...
                Some(ErrorInfo {
                    sub_code: match SolClientSubCode::from_u32(error_info.subCode) {
                        Some(sub_code) => SolClientSubCodeOrU32::SubCode(sub_code),
                        None => SolClientSubCodeOrU32::Raw(error_info.subCode),
                    },
